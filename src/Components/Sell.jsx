    ...
    <div className="flex flex-col bg-[#373737] px-10 relative">
      <div className="absolute bg-[#808080] w-3/4 md:w-2/3 -top-14 left-16 md:-top-10 md:left-[160px] lg:left-[220px] flex justify-center items-center rounded-2xl opacity-80 ">
        <div className="flex flex-col text-center md:flex-row md:text-start gap-1 items-center py-2 sm:py-6 px-2 border-r-2 border-[rgb(255,215,0)]">
          ...
          <img
            ...
            alt="image"
          />
          <h2 className="text-white font-Averia font-semibold text-lg md:text-2xl hover:text-yellow-500">
            Quality Equipments
          </h2>
        </div>
        <div className="flex flex-col text-center md:flex-row md:text-start gap-1 items-center py-2 sm:py-6 px-2 border-r-2 border-[rgb(255,215,0)]">
          <img src={wLoss} width={50} alt="image" />
          <h2 className="text-white font-Averia font-semibold sm:lg md:text-2xl hover:text-yellow-500">
            Weight Loss
          </h2>
        </div>
      ...
      <div className="py-32 flex flex-col md:flex-row items-center justify-around gap-10">
        <div className="left relative  ">
          ...
          />
          <div className="absolute sm:w-48 bg-white text-center font-semibold t text-black hover:text-white hover:bg-yellow-500 font-Poppins px-5 sm:px-10 py-3 right-20 top-[92%] sm:-right-20 sm:top-[50%] rounded-2xl">
...
He is stronger and has less risk of being out of balance and falling causing fractures or other injuries
          ...
          <button className="px-3 py-1 bg-[rgb(255,215,0)] rounded-xl w-28 hover:bg-white text-white hover:text-yellow-500">
            Buy Now
          </button>
        </div>
      </div>
